...
allprojects <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>再次在项目目录路径下终端运行<code>flutter run</code></li></ol><p>若上述步骤都试过无效，删除下面路径的两个文件，分别是<code>caches</code>和<code>wrapper/dists</code>： <img src="`+c+'" alt="" loading="lazy"></p><div class="hint-container warning"><p class="hint-container-title">注意</p><p>上面步骤修改完，无论是AS上运行，还是终端上输入<code>flutter run</code>命令，可能还是会觉得有点慢<code>Running Gradle task &#39;assembleDebug&#39;</code>，此时你可以看<code>wrapper/dists</code>文件下的文件大小是否在增长，若增长可观，就代码等待一会，一般大小会是400M左右，具体可看下图。</p></div><figure><img src="'+p+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>有可能你的<code>wrapper/dists</code>下有多个文件，你知道看哪一个，可以在项目的android文件夹下要下载哪个文件： <img src="'+u+'" alt="" loading="lazy"></p><p>还可以可能会提示报错如<code>Could not get source at xxxx</code>和<code>xecution failed for task &#39;&#39;:app:checkDebugAarMetadata&#39;</code>，大致意思意思不能在阿里云获取资源啥的，但是跑一会就莫名奇妙没报错了。以上也是我最终成功跑起来的配置。</p><p>上面的方法都是笔者总结出来的，然后最终运行成功：</p><figure><img src="'+n+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',17),v=[m];function g(b,k){return e(),a("div",null,v)}const y=s(d,[["render",g],["__file","flutter-assembleDebug.html.vue"]]),_=JSON.parse(`{"path":"/bug/flutter-assembleDebug.html","title":"Flutter运行安卓模拟器上一直卡在Running Gradle task 'assembleDebug'","lang":"zh-CN","frontmatter":{"title":"Flutter运行安卓模拟器上一直卡在Running Gradle task 'assembleDebug'","date":"2023-05-29T00:00:00.000Z","category":["bug记录"],"description":" 错误图： 你可以一直等，但是显然这是非常影响开发效率的，下面是解决方案： 首先找到fultter sdk所在文件夹的位置：依次进flutter\\\\packages\\\\flutter_tools\\\\gradle 文件夹，然后打开flutter.gradle文件，如下图： 然后进行以下修改： 60行左右进行第一次修改： 87行左右进行第二次修改： 回到flut...","head":[["meta",{"property":"og:url","content":"https://github.com/xinyang424/bug/flutter-assembleDebug.html"}],["meta",{"property":"og:site_name","content":"XinYang"}],["meta",{"property":"og:title","content":"Flutter运行安卓模拟器上一直卡在Running Gradle task 'assembleDebug'"}],["meta",{"property":"og:description","content":" 错误图： 你可以一直等，但是显然这是非常影响开发效率的，下面是解决方案： 首先找到fultter sdk所在文件夹的位置：依次进flutter\\\\packages\\\\flutter_tools\\\\gradle 文件夹，然后打开flutter.gradle文件，如下图： 然后进行以下修改： 60行左右进行第一次修改： 87行左右进行第二次修改： 回到flut..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"XinYang's Blog"}],["meta",{"property":"article:published_time","content":"2023-05-29T00:00:00.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Flutter运行安卓模拟器上一直卡在Running Gradle task 'assembleDebug'\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-05-29T00:00:00.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"XinYang's Blog\\",\\"url\\":\\"https://xinyang424.com\\"}]}"]]},"headers":[],"git":{"contributors":[{"name":"coder-new","email":"2578417052@qq.com","commits":1}]},"readingTime":{"minutes":2.03,"words":609},"filePathRelative":"bug/flutter-assembleDebug.md","localizedDate":"2023年5月29日","autoDesc":true}`);export{y as comp,_ as data};
